package predavanje8.si.fri.kodiranje.main;

import predavanje8.si.fri.kodiranje.gui.KodiranjeOkno;
import predavanje8.si.fri.kodiranje.io.BeriPisi;
...
public class Kodiranje {
  ...
  public static void main(String[] args) {
    ...
    if (args.length >= 4) {
      ...
      // ...  sicer (če argumenti niso podani) odprem GUI okno, iz katerega metodo doKodiranje()
      //      kličem šele takrat, ko uporabnik pritisne gumb "kodiraj / odkodiraj"
      
      // ustvarim in prikažem GUI okno
