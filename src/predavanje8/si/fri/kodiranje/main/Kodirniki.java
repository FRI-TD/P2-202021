...
// Uporabljam lahko tudi razrede, ki niso dele standardne jave; taki razredi
// so običajno zapakirani v jar datoteko; tako jar datoteko moram shraniti
// v mapi svojega računalnika (običajno v mapi lib znotraj projekta) ter
// jo povezati s projektom (Libraries / Add JAR/Folder).
